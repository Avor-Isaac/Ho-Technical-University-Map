...
// MOUSE WHEEL ZOOM
// =====================
let wheelLocked = false; // prevents accidental wheel zoom right after a location click
...
function triggerLocation(locationKey) {
  ...
  // Briefly lock wheel zoom so trackpad scroll after click doesn't zoom accidentally
  wheelLocked = true;
